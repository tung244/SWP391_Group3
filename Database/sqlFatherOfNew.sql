...
service_detail_id INT IDENTITY(1,1) NOT NULL PRIMARY KEY,
service_detail_name NVARCHAR(255),
service_detail_descriptprion NVARCHAR(255),
)
...
CREATE TABLE Appointment(
	...
	patient_id int,
	FOREIGN KEY (patient_id) REFERENCES Account(account_id) ,
...
FOREIGN KEY(author_id) REFERENCES dbo.Account(account_id)
