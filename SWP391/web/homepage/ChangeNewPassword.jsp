...
<html lang="en">
    ...
    <body style="background-image: url(homepage/images/resources/v870-tang-36.jpg);" class="bg-light">
        <div style="background-color: white; margin-top: 50px" class="custom-register-container">
            ...
            <form style="padding: 0 20px;" action="changeNewpassword" method="post" class="custom-register-form" id="customRegisterForm" novalidate>
                <div class="row">
                    <!-- Left Column -->
                    <div class="col-md-6">
                        ...
                        <!-- Phone -->
                        <div class="form-group">
                            <label for="customPhone">Current Pass</label>
                            <input type="tel" class="form-control" id="register-phone" name="current_password" required>
