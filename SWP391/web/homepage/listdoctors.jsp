        ...
        <div class="boxed_wrapper">
            ...
            <div style="margin-top: 30px" class="container">
                <form action="searchdoctor" method="POST">
                    <div style="width: 500px; margin-left: 55% " class="search-filter-box">
                        <input name="txt" value="${txtS}" type="text" id="searchName" class="form-control" placeholder="Find doctor by name">
                        <button style=" background-color:#228B22" type="submit" class="btn-search">Search</button>       
                    </div>
                </form>
