    ...
    <body>
                        ...
                        <form id="massEmailForm">
                            <div class="mei-grid">
                                ...
                                <div class="mei-card">
                                    ...
                                    <div class="mei-form-group">
                                        ...
                                        <input type="text" class="mei-input" required placeholder="VD: Tầm soát đục thủy tinh thể">
                                    </div>
                                    <div class="mei-form-group">
                                        <label class="mei-label">Nhóm bệnh nhân</label>
                                        <select class="mei-select" required>
                                            <option value="">Chọn nhóm bệnh nhân</option>
                                            <option value="new">Bệnh nhân mới</option>
                                            <option value="followup">Bệnh nhân tái khám</option>
                                            <option value="surgery">Bệnh nhân phẫu thuật</option>
                                            <option value="elderly">Nhóm cao tuổi</option>
                                            <option value="children">Nhóm trẻ em</option>
                                        </select>
                                    </div>
                                </div>
                            ...
                            <div class="mei-card" id="customTemplateSection" style="display: none;">
                                ...
                                <div class="mei-form-group">
                                    ...
                                    <input type="text" class="mei-input" placeholder="Nhập tiêu đề email...">
                                </div>
                                <div class="mei-form-group">
                                    <label class="mei-label">Nội dung</label>
                                    <textarea class="mei-textarea" placeholder="Nhập nội dung email của bạn..."></textarea>
                                </div>
                            </div>
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            document.getElementById('massEmailForm').addEventListener('submit', function(e) {
                e.preventDefault();
                alert('Đã gửi yêu cầu gửi email marketing!');
            });
