                                                ...
                                                <div class="col-lg-3 col-md-4">
                                                    <div class="doctor-thumb text-center">
                                                        ...
                                                        <div class="star-rating text-warning mb-2">
                                                            ...
                                                            <span class="text-muted ml-2">Rating: <fmt:formatNumber value="${d.rating}" type="number" maxFractionDigits="1" minFractionDigits="1" /></span> ★
                                                            </br>
                                                            <span class="text-muted ml-2">(${countReview} reviews)</span>
