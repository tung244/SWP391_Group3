                    ...
                    <div class="page-content">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <c:forEach items="${requestScope.listFWP}" var="feedback_customer_support">
                                            <div class="progress-wrapper mb-4">
                                                <p class="mb-1">${feedback_customer_support.appointment.staff.admin_fullname} <span class="float-end">${feedback_customer_support.average_rating}</span>
                                                </p>
                        ...
                        <div class="card radius-15">
                            ...
                            <div class="card-body">
                                <div class="d-flex align-items-center mb-3">
                                    ...
                                    <select id="rating" class="form-select me-2" onchange="filterFeedback()">
                                    ...
                                    <select id="support" class="form-select me-2" onchange="filterFeedback()">
                                        <option value="">All</option>
                                        <c:forEach items="${requestScope.listFWP}" var="feedback_customer_support">
                                            <option value="${feedback_customer_support.appointment.staff.admin_fullname}">${feedback_customer_support.appointment.staff.admin_fullname}</option>
                                        </c:forEach>
                                    </select>

                                    <label for="date" class="me-2">Date:</label>
                                    <input type="date" id="date" class="form-control me-2" onchange="filterFeedback()">
                                </div>
                                ...
                                <div class="table-responsive">
                                        ...
                                        <tbody id="feedbackTable">
                                            <c:forEach items="${requestScope.listF}" var="listF">
                                                <tr>
                                                    ...
                                                    <td>${listF.appointment.staff.admin_fullname}</td>
                                    ...
                                    <div class="pagination">
                                        <c:if test="${page > 1}">
                                            <a href="dashboardcustomersupport?page=${page - 1}">«</a>
                                        </c:if>

                                        <c:forEach var="i" begin="1" end="${numpage}">
                                            <a href="dashboardcustomersupport?page=${i}" class="${i == page ? 'active' : ''}">${i}</a>
                                        </c:forEach>
                        ...
                        <script>
                            function filterFeedback() {
                                ...
                                const supportFilter = document.getElementById('support').value;
                                const dateFilter = document.getElementById('date').value;

                                const rows = document.querySelectorAll('#feedbackTable tr');

                                rows.forEach(row => {
                                    const rating = row.cells[2].innerText; // Rating Column
                                    const customerSupport = row.cells[4].innerText; // Customer Support Column
                                    const feedbackDate = row.cells[5].innerText; // Feedback Date Column
                                    ...
                                    if (supportFilter && customerSupport !== supportFilter) {
                                        showRow = false;
                                    }

                                    if (dateFilter && feedbackDate !== dateFilter) {
                                        showRow = false;
                                    }
