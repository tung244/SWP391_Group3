                            ...
                            <div class="card">
                                <div class="card-body">
                                    <div class="card-title">
                                        <h4  class="mb-0">Censor Doctor Certificate Table</h4>
                                    </div>                                   
                                </div>
                                <h4 style="color: #228B22;
                                    margin-left: 3%"  class="mb-0">Checking Update Certificate List</h4>
                                <hr/>
                                <div class="pagination-container" style="margin-left: auto;">
                                    ...
                                    <label for="pageSize">certificates per page</label>
                                </div>
                                        ...
                                        <table id="example" class="table table-striped table-bordered" style="width:96%;
                                            ...
                                            <thead style="text-align: center">
                                                <tr>
                                                    ...
                                                    <th scope="col" style="color: green">Certificate Id</th>
                                                    <th scope="col" style="color: green">Doctor Name</th>
                                                    <th scope="col" style="color: green">Certificate Image</th>
                                                    <th scope="col" style="color: green">Certificate Name</th>         
                                                    <th scope="col" style="color: green">Date Certificate</th>
                                            ...
                                            <tbody style="text-align: center">
                                                <c:forEach var="lcd" items="${listCerDoc}">
                                                    <tr>

                                                        <td>${lcd.certificate_id}</td>
                                                        <td>${lcd.doctor.doctor_name}</td>
                                                        <td><img src=".${lcd.certificate_image}" width="150px" height="150px" alt="Certificate Image"/></td>
                                                        ...
                                                        <td>  
                                                            <form action="checkingUpdateCertificateDoctor" method="POST">
                                                                <input type="hidden" name="doctor_id" value="${lcd.doctor_id}"> 
                                                                <input type="hidden" name="certificate_id" value="${lcd.certificate_id}"> 
                                                                <select style="background-color:#228B22;
                                                                        color: #ffffff" name="status" onchange="confirmStatusChange(this)" data-original="${lcd.status}">
                                                                    <option style="background-color:#ffffff;
                                                                            color: #228B22" value="Accept" ${lcd.status == 'Accept' ? 'selected' :''}>Accept</option>
                                                                    <option style="background-color:#ffffff;
                                                                            color: #228B22" value="InProgress" ${lcd.status == 'InProgress' ? 'selected' :''}>In Progress</option>
                                                                    <option style="background-color:#ffffff;
                                                                            color: #228B22" value="Reject" ${lcd.status == 'Reject' ? 'selected' :''}>Reject</option>
                                                                </select>
                                                            </form> 
                                                        </td>
                                                    </tr>
                                ...
                                <h4 style="color: #228B22;
                                    margin-left: 3%" class="mb-0">History Censor Doctor Certificate</h4>
                                <hr/>
                                <div class="pagination-container" style="margin-left: auto;">
                                    ...
                                    <label for="historyPageSize">certificates per page</label>
                                </div>
                                <div class="table-responsive">
                                    <div id="historyDegreeList">
                                        <table id="historyTable" class="table table-striped table-bordered" style="width:96%;
                                            ...
                                            <tbody style="text-align: center">
                                                <c:forEach var="hist" items="${historyCerDoc}">
                                                    <tr>
                                                        <td>${hist.certificate_id}</td>
                                                        <td>${hist.doctor.doctor_name}</td>
                                                        <td><img src=".${hist.certificate_image}" width="150px" height="150px" alt="certificate Image"/></td>
...
<script>
                    ...
                    function confirmStatusChange(selectedElement) {
                        if (confirm('Are you sure to change the status of certificate doctor!')) {
                    ...
                    function loadCertificate(page = 1) {
                        let pageSize = document.getElementById("pageSize").value;
                        $.ajax({
                            url: "checkingUpdateCertificateDoctor",
                            type: "GET",
                            data: {
                    ...
                    $(document).on("click", ".pagination a", function (e) {
                        ...
                        if (page) {
                            loadCertificate(page);
                        }
                    });


                    // Function to load history degrees
                    function loadHistoryCertificate(page = 1) {
