        ...
        <div class="wrapper">
            ...
            <div class="sidebar-wrapper" data-simplebar="true">
                <div class="sidebar-header">
                    <div class="">
                        <img src="../homepage/images/resources/logoicon.png" class="logo-icon-2" width="100px" alt="" />
                    </div>
                    <div>
                        <h4 class="logo-text">EYECARE</h4>
                    </div>
                ...
                <ul class="metismenu" id="menu">
                    ...
                    <li>
                        <a href="/SWP391/admin/ServiceList">
                            <div class="parent-icon icon-color-8"> <i class="lni lni-envato"></i>
                            </div>
                            <div class="menu-title">Services</div>
                        </a>
                    </li>
                    <li>
                        <a href="/SWP391/admin/StaffList">
                    ...
                    <li>
                        ...
                        <ul>
                            ...
                            <li> <a href="/SWP391/admin/ServiceList">
                                    <i class="bx bx-right-arrow-alt"></i> Editable Table
                                </a>
                            </li>
                        </ul>
                    </li>
