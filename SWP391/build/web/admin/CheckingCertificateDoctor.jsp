                        ...
                        <div class="page-content">
                                ...
                                <div class="ps-3">
                                    <nav aria-label="breadcrumb">
                                        <ol class="breadcrumb mb-0 p-0">
                                            ...
                                            <li class="breadcrumb-item active" aria-current="page"><a>List Censor Certificate Doctor</a></li>
                                        </ol>
                                    </nav>
                                </div>
                            ...
                            <div class="card">
                                ...
                                <h4 style="color: #228B22;
                                    margin-left: 3%"  class="mb-0">Checking Add Certificate List</h4>
                                <hr/>
                                            ...
                                            <tbody style="text-align: center">
                                                <c:forEach var="lcd" items="${listCerDoc}">
                                                    <tr>
                                                        ...
                                                        <td>  
                                                            <form action="checkingCertificateDoctor" method="POST">
