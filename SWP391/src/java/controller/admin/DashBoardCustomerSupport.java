...
public class DashBoardCustomerSupport extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        System.out.println("Monthly Feedback Size: " + listFM.size());
        for (FeedbackService feedback : listFM) {
            System.out.println("Month: " + feedback.getMonth() + ", Average Rating: " + feedback.average_rating);
        }
