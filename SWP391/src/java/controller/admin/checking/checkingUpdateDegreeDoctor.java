 ...
 * @author PC
 */
@WebServlet(name = "checkingUpdateDegreeDoctor", urlPatterns = {"/admin/checkingUpdateDegreeDoctor"})
public class checkingUpdateDegreeDoctor extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        List<Degree_Doctor> listDeDoc = dedocdao.getCensorUpdateDoctorDegree();
        ...
        List<Degree_Doctor> historyDeDoc = dedocdao.getUpdateDoctorDegreeHistory();
        ...
        request.getRequestDispatcher("CheckingUpdateDegreeDoctor.jsp").forward(request, response);
    }
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        if (status.equals("Accept")) {
            boolean success = dedocdao.acceptUpdateDegreeDoctor(doctor_id, degree_id);
            if (success) {
                request.getSession().setAttribute("success", "The degree update successfully!");
                response.sendRedirect("checkingUpdateDegreeDoctor");
            }
        } else if (status.equals("Reject")) {
            boolean success = dedocdao.rejectUpdateDegreeDoctor(doctor_id, degree_id);
            if (success) {
                request.getSession().setAttribute("success", "The degree update rejected!");
                response.sendRedirect("checkingUpdateDegreeDoctor");
            }
        }
    }
