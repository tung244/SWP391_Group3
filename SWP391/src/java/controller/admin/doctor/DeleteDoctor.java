...
public class DeleteDoctor extends HttpServlet {
    ...
    throws ServletException, IOException {
        ...
        boolean success = dao.deleteDoctor(did);
        if (success) {
            response.sendRedirect("doctorList.jsp?message=Doctor deleted successfully");
        } else {
            response.sendRedirect("doctorList.jsp?error=Failed to delete doctor");
        }
    }
